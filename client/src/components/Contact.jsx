  ...
  return (
    ...
    { landlord && (
        <div className='flex flex-col gap-2'>
            ...
            <textarea name='message' id='message' rows='2' value={message} onChange={onChange} placeholder='Ente your message here...' className='w-full border p-3 rounded-lg'></textarea>
