...
const handleImageSubmit = (e) =>{
    if(files.length > 0 && files.length + formData.imageUrls.length < 7){
        ...
        Promise.all(promises).then((urls)=>{
            ...
            setImageUploadError("Image upload failed (2 mb max for per image)");
...
// handle change when value changes in inputs or numbers of form data
        ...
        <form  onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-8'>
              <div className="flex flex-col gap-4 flex-1">
                ...
                <div className=" flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <input type='number' id='regularPrice' min='50' max='4000000' required className='p-3 border border-gray-300 rounded-lg'
                        onChange={handleChange}value={formData.regularPrice} />
                        <div className='flex flex-col items-center'>
                        <p>Regular price</p>
                        <sapn className='text-xs'>($/month)</sapn>
                        </div>
                    </div>
                    { formData.offer  && (

                    <div className="flex items-center gap-2">
                        <input type='number' id='discountPrice' min='0' max='100000' required className='p-3 border border-gray-300 rounded-lg'
              ...
              <div className='flex flex-col flex-1 gap-4'>
                  ...
                  <div className='flex gap-4'>
                    ...
                    <button type='button' onClick={handleImageSubmit} disabled={uploading} className='p-3 text-green-700 border
